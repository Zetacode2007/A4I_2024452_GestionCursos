...
insert into estudiantes (nombre, apellido, correo, id_curso)
	values 	('Pablo','Hernandez','phernandez-2024329@gmail.com',1),
			('Ana', 'Martínez', 'amartinez-2024330@gmail.com', 1),
			('Luis', 'Gómez', 'lgomez-2024331@gmail.com', 1),
			('Carla', 'Ruiz', 'cruiz-2024332@gmail.com', 1),
			('Javier', 'Fernández', 'jfernandez-2024333@gmail.com', 1),
			('Lucía', 'Torres', 'ltorres-2024334@gmail.com', 1),
			('Miguel', 'Sánchez', 'msanchez-2024335@gmail.com', 1),
			('Valeria', 'Díaz', 'vdiaz-2024336@gmail.com', 1),
			('Andrés', 'López', 'alopez-2024337@gmail.com', 1),
